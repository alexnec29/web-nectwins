...
$exerciseRows = $pdo->query("SELECT * FROM get_top_exercises($uid, 'fizio', 5)")->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    ...
    <div class="rss-section">
        ...
        <a href="rss-fizio.php" class="rss-link" target="_blank">📥 Vezi fluxul RSS</a>
    </div>
</body>
