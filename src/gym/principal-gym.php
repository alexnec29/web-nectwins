...
<head>
    ...
    <link rel="stylesheet" href="css/principal-gym.css">
</head>
...
<body>
    <nav>
        ...
        <form method="post">
            ...
            <button type="submit" class="gym buton-apasat">
        ...
        <form method="post">
            ...
            <button type="submit" class="kineto">
        ...
        <form method="post">
            ...
            <button type="submit" class="fizioterapie">
